    ...
    <div className="overflow-hidden rounded-xl border border-border bg-card/80">
      ...
      <ul className="divide-y divide-border/60">
        {projects.map((project) => (
          ...
          >
            <span className="truncate text-foreground/80">{project.slug}</span>
  ...
  return (
    <section className="relative overflow-hidden">
      <div aria-hidden className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_-10%,rgba(255,214,170,0.07),transparent)]" />
      </div>
      <Container className="relative grid gap-16 pt-24 pb-20 md:pt-32 md:pb-28 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-center">
        <div>
          <Entrance delay={0}>
          ...
          <Entrance delay={0.15}>
            <div className="mt-10 flex flex-wrap items-center gap-3">
              <Link href="/projects" className={cn(buttonVariants(), "h-11 px-6")}>
                View projects
