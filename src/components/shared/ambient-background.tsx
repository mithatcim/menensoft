 ...
 * ambient glows (one warm amber, one faint cool — cool is depth only, never an
...
export function AmbientBackground() {
  return (
    ...
    >
      ...
      <div className="animate-drift-a absolute -top-[15%] left-[8%] h-[70vh] w-[70vh] rounded-full bg-[radial-gradient(circle,rgba(255,201,143,0.10),transparent_62%)]" />
      <div className="animate-drift-b absolute -bottom-[12%] right-[4%] h-[58vh] w-[58vh] rounded-full bg-[radial-gradient(circle,rgba(122,152,255,0.06),transparent_62%)]" />
